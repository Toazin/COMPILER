...
function name_of_function () {
  ...
  if(verify("flip") || verify("getCard") || verify("putCard") ){
    ...
    console.log("tt[tti]", tt[tti]);
    console.log("st", st);
    console.log("tt[tti] existe en st?: ", st[tt[tti]])
    if(!palabras_reservadas.includes(tt[tti]) && st[tt[tti]] > 0){
      tti++;
      
      
    }else{
      //console.log();
      var msg = "El token: '" + tt[tti] + "' is not a defined user function";
      alert(msg);
      throw new Error(msg);
    }
    */
...
function isCustomFunction(){
  /*
  console.log("Ya esta definida?: ", tt[tti], st[tt[tti]]);
  console.log("st[tt[tti]] == undefined", st[tt[tti]] == undefined);
  console.log("Is }?: ", tt[tti] == "}");
  console.log(st);
  console.log("Entrara a Error?: ", (st[tt[tti]] == undefined && tt[tti] != "}"));
  
  if(st[tt[tti]] == undefined && tt[tti] != "}"){
    var msg = "The token: '" + tt[tti] + "' is not a custom function";
    alert(msg);
    throw new Error(msg);
  }
  
  console.log("Palabra a buscar: ", tt[tti]);
  console.log("ST ", st);
  console.log("Is in ST", st[tt[tti]] > 0);
  console.log("IsCUstomFunction: ",!palabras_reservadas.includes(tt[tti]) );
  */
